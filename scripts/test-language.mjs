const cases = [
    ...
    ['compile-bad-pipe-placeholders', ['compile', 'scripts/fixtures/compile_bad_pipe_placeholders.utu'], 1, 'Parse errors:'],
    ...
    ['run-hello-name', ['run', 'examples/hello_name.utu'], 0, 'hello utu'],
