...
export function resolveBareValue(name, ctx) {
...
export function resolveValueType(name, ctx) {
...
export function resolveFunctionReturn(name, ctx) {
...
export function resolveNamespaceValueReturn(namespace, memberName) {
...
export function resolveAssociatedByOwner(ownerName, memberName, ctx) {
    const entry = this.resolveAssociatedEntry(ownerName, memberName, ctx);
    return entry?.callee;
}

export function resolveNamespaceValue(namespace, memberName) {
...
export function resolveNamespaceAssoc(namespace, ownerName, memberName) {
...
export function resolveAssociatedEntry(ownerName, memberName, ctx) {
...
export function resolveAssociatedEntryFromInfo(info, memberName, ctx) {
...
export function resolveProtocolDispatchFromInfo(info, memberName, totalArgCount = 1) {
...
export function inferJoinedExprInfo(nodes, ctx) {
...
export function resolveFieldExprInfo(node, ctx) {
...
export function inferExprInfo(node, ctx) {
    if (!node) return null;
    switch (node.type) {
        case 'identifier':
...
export function inferCallExprInfo(node, ctx) {
...
export function resolveAssociatedReturn(ownerNode, memberName, ctx) {
...
export function emitCallExpr(node, ctx) {
    const callee = kids(node)[0];
    const argNodes = kids(childOfType(node, 'arg_list'));
...
export function emitFieldExpr(node, ctx) {
...
export function resolveMethodCall(node, ctx, totalArgCount = 1) {
    const [baseNode, memberNode] = kids(node);
...
export function resolveBuiltinMethodDispatch(info, memberName) {
...
export function resolveModuleField(node, ctx) {
    const [baseNode, memberNode] = kids(node);
...
export function resolveTypeMemberExpr(node, ctx) {
...
export function emitNamespaceCallExpr(node, ctx) {
...
export function emitPromotedModuleCall(node, ctx) {
    const memberNode = childOfType(node, 'identifier');
    const argsNode = childOfType(node, 'arg_list');
...
export function emitPipeExpr(node, ctx) {
...
export function parsePipeTarget(node, ctx) {
...
export function parsePipeArgs(node) {
    if (!node) return [];
...
export function emitIfExpr(node, ctx) {
...
export function emitPromoteExpr(node, ctx) {
    const parts = kids(node);
    const expr = parts[0];
...
export function emitMatchExpr(node, ctx) {
...
export function emitBlockExpr(node, ctx) {
...
export function resolveProtocolTypeMemberCall(node, argNodes, ctx) {
    const memberNode = childOfType(node, 'identifier');
    const ownerNode = kids(node).find((child) => child !== memberNode);
...
export function resolveProtocolOwnerNode(node, ctx) {
    if (!node) return null;
...
export function protocolSelfType(node, ctx) {
...
export function protocolImplKey(protocol, member, selfType) {
    return `${protocol}.${member}:${selfType}`;
}

export function protocolMemberKey(protocol, member) {
    return `${protocol}.${member}`;
}

export function protocolTypeMemberKey(selfType, member) {
    return `${selfType}.${member}`;
}

export function emitForExpr(node, ctx) {
...
export function emitForSources(node, ctx) {
...
export function emitWhileExpr(node, ctx) {
...
export function emitBindExpr(node, ctx) {
...
export function emitArrayInit(node, ctx) {
...
export function emitBlock(node, ctx, reuseCurrentScope = false) {
