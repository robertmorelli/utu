import { createStage2ExpansionState, disposeStage2ExpansionState } from "./expansion-state.js";
import { materializeStage2ExpandedSource } from "./materialize-source.js";
import { needsExpansion, normalizeExpandOptions } from "./prepare-expansion.js";
...
function createApiState(treeOrNode, source, options = {}) {
    ...
    return createStage2ExpansionState({
        ...
        expandOptions: {
            ...normalizeExpandOptions(options),
            shouldExpand,
